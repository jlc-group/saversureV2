...
/**
 * WalletFallback — original hard-coded layout kept as safety net.
 * ใช้เมื่อ page_configs ไม่มี slug 'wallet' หรือ API error
 */
...
export default function WalletPage() {
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      <Navbar />
      <div className="pt-24">
        <PageRenderer pageSlug="wallet" fallback={<WalletFallback />} />
      </div>
      <BottomNav />
    </div>
  );
