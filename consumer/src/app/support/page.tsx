      ...
      <div className="pt-24">
        ...
        <div className="bg-[linear-gradient(277.42deg,#3C9B4D_-13.4%,#7DBD48_80.19%)] px-5 pt-6 pb-14 text-white relative overflow-hidden">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[36px] sm:text-[42px] font-black tracking-tight leading-[1.1] mb-1 drop-shadow-md">คำถามที่พบบ่อย</h1>
              <p className="text-[15px] font-medium text-white/95 mt-0.5">รวมคำตอบและวิธีการใช้งานเบื้องต้น</p>
            </div>
          </div>
        </div>
