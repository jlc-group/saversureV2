          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              <input
                ...
                placeholder=" "
                className="
                  peer w-full px-4 pt-5 pb-2 pr-12 border border-[var(--md-outline)]
                  rounded-[var(--md-radius-sm)] text-[14px] text-[var(--md-on-surface)]
                  bg-transparent outline-none
                  focus:border-[var(--md-primary)] focus:border-2
                  transition-all duration-200
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--md-on-surface-variant)] hover:text-[var(--md-on-surface)] transition-colors"
                tabIndex={-1}
